const db = [
  {
    ...
    price: 19.99,
    description:
      "High-quality product with excellent features. Perfect for outdoor adventures, offering warmth and durability in harsh conditions.",
    images: [
  ...
  },
  {
    ...
    price: 39.99,
    description:
      "Professional-grade product with advanced capabilities. Multiple pockets and reinforced stitching make these pants ideal for active lifestyles.",
    images: [
